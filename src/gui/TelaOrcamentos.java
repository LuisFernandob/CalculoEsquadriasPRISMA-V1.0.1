...
public class TelaOrcamentos extends javax.swing.JFrame implements KeyListener{
    ...
    private void initComponents() {
		...
		jButton1.setToolTipText("Cria um novo orçamento (Cria apenas o \"título\" com a descrição do orçamento, bem como realiza a conexão do novo orçamento com um cliente cadastrado");
		...
		jButton2.setToolTipText("Exclui o orçamento selecionado (Exclui inclusive todos os registros dos produtos cotados no orçamento)");
		...
		jButton3.setToolTipText("Altera a descrição do orçamento selecionado (Para alterar os produtos cotados no orçamento clique em \"ABRIR ORÇAMENTO\")");

        jButton4.setText("ABRIR ORÇAMENTO");
		...
		jButton4.setToolTipText("Abre o orçamento selecionado para alterar produtos cotados no orçamento");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {                                     
    	...
    	if (selecao != -1) {
    		if (selecao == 0 && linhaSelecionada == jTable1.getSelectedRow()) {
    			...
    			} else {JOptionPane.showMessageDialog(null, "Selecione um orçamento para alterar!");}
    		selecao = -1;
    		linhaSelecionada = -1;
	...
	if(key == KeyEvent.VK_ENTER)
     {
    	...
    	} else {JOptionPane.showMessageDialog(null, "Selecione um orcamento para alterar!");}   
     ...
     } else if(key == KeyEvent.VK_DELETE)
     {
    		...
    		if (jTable1.getSelectedRow() != -1) {
             ...
             } else {JOptionPane.showMessageDialog(null, "Selecione um orcamento para excluir.");}    
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    	...
    	if (jTable1.getSelectedRow() != -1) {
    	 ...
    	 } else {JOptionPane.showMessageDialog(null, "Selecione um Orcamento para incluir, excluir ou alterar produtos contidos nele!");}       
